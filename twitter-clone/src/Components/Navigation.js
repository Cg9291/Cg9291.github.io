...
export default function Navigation(props){
    return (
      <nav>
        <ul>
          <a href="#">
            <li className="nav-list-items" id="nav-twitter-logo-item">
              <svg id="nav-twitter-logo-icon" className="nav-list-icons" viewBox="0 0 24 24" aria-hidden="true" overflow='visible'>
